...
export default window.createClass<ControlProps, State, Spec>({
    ...
    render: function(this: This) {
        const fill = this.state.inputType === 'password' ? 'rgb(121, 130, 145)' : 'rgb(58, 105, 199)';
